...
![screenshot](screenshots/lucien.png)
...
L'expérience est une métaphore de l'insoutenable légerté de l'être qui porte à la méditation sur la vacuité de la vie et la futilité du du libre arbitre dans une logique de déterminisme absolu.
...
javascript, matterjs, webaudio api, gamepad api, café noisette
...
[Voice Hero](https://github.com/sienning/Webaudio)

![screenshot](screenshots/voice-hero.gif)

## auteur

[Léna ENG](https://www.instagram.com/sienning/) [@sienning](https://github.com/sienning)

## l'expérience

Le but est de jouer en rythme en pressant les touches correspondantes à celles qui apparaissent sur l'écran. 

## le but

Ayant toujours aimé la musique, mais n'ayant jamais pu jouer à guitar hero, j'ai voulu créé un jeu qui permettait de générer les notes selon la musique donnée.

## techno

React, Webaudio API, gamepads
...
![screenshot](screenshots/guitareZero.gif)

## auteur

[Antoine Galy](https://antoine-galy.com/) [@tlztonio](https://github.com/tlztonio)

## l'expérience

Guitare Hero mais avec un Z, on joue avec un clavier externe et un télephone collé dessus pour les cordes.

## le but

Appuyer sur les bonnes touches au bon moment pour jouer la musique. Pour les touches blanches il faut toucher les cordes en meme temps que la note sur le clavier.

## techno

Threejs, socket, express
...
[3D_sound_Visualisation](https://github.com/kaba992/BoatExp)

![screenshot](screenshots/projet_image_ibra.png)

## auteur

[kaba_ibrahima](SITE_WEB_TWITTER_OU_NIMPORTE) [@USER_GITHUB](https://github.com/kaba992)

## l'expérience

Une Visualisation en 3d du son avec un shader qui update la geometrie de ma sphere en fonction de la fréquence du son.
les particles de papillon sont genérés aussi grace à cette meme fréquence et elle suivement un pattern qui augmente le volume en fonction de la fréquence.
et enfin une mer car avec un effet de refraction qui reflète la sphere et les particles.

## le but

Expérimenter les shaders et les particules

## techno

javascript, threejs, shader, audio

## license

Libre de droit pour quiquonque veut l'utiliser!
...
[Burning Kitchen](https://github.com/LouisePrd/burning-kitchen)

![screenshot](screenshots/burning-kitchen-demo.gif)

## auteur

PERIDY LOUISE @lwiz.prd [@LouisePrd](https://github.com/LouisePrd)
...
[Flip Phone](https://flip-phone.vercel.app/)

![screenshot](screenshots/flip_phone.gif)

## auteur

[Clément Renou](https://twitter.com/LeFlanb) [@flanb](https://github.com/flanb)

## l'expérience

Comme son nom l'indique, flip ton phone et passe des moments de delirade avec tes potes !

## le but

Adel est frustré de ne pas pouvoir compté ses points lorsqu'il joue à tourner son téléphone. Mais un beau jour il découvre Flip Phone qui changera sa vie...

## techno

svelte, orientation API
...
[Benzema Simulator](https://github.com/kodypistol/benzema-simulator)

![screenshot](screenshots/benzema-simulator.png)

## auteur

[Adel SANAA](https://www.tiktok.com/@starkmehdi) [@kodypistol](https://github.com/kodypistol)

## l'expérience

Je vous propose de réaliser votre rêve caché de devenir footballer professionnel. Grâce à votre téléphone et votre ordinateur, vous pouvez vous entraîner à tirer des buts dans la vie réelle et perfectionner vos mouvements.

## le but

Derrière ce projet se cache la volonté de découvrir de nouveaux moyens originaux d'intéragir avec une expérience. L'accéléromètre du téléphone est très puissant et m'a donné envie de découvrir comment pouvoir l'utiliser concrètement sur le web et de façon originale.

## techno

Typescript, Three.js, Socket.io, Cannon-ES, Vite, Lottie, Web Audio API, DeviceMotionAPI, DeviceOrientationAPI, Localtunnel
