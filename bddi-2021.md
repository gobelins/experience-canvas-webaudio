...
# thoma
<!-- s'il y a une démo, mettez le lien-->
[blue](https://blue.thomalecornu.fr)

![screenshot](screenshots/chrome-capture.gif)
...
<!-- qui etes vous, lien + pseudo github) -->
[Thoma Lecornu](https://thomalecornu.fr)  [@ThomaLecornu](https://github.com/ThomaLecornu)

## l'expérience

<!-- petite description de l'expérience-->
Expérience en Three.js utilisant l'API Audio. Je suis parti sur une DA assez immersive et axée sur le centre de la scène. J'ai imaginé l'environnement et les différents effets en fonction de la sphère. Tous les éléments sont animés en fonction des différentes fréquences de la musique.

## le but

<!-- avez-vous un but? sinon trouvez-en un :D parfois s'amuser, c'est un but -->
Je voulais faire une expérience sonore visuelle et interactive :D
...
[FindAndEar](https://github.com/Pamavoc/gob-webaudio)

(démo et image manquantes)
